        ...
        <div className="footer-max-width thq-section-max-width">
          ...
          <div className="footer-credits">
            ...
            <div className="footer-row">
              <span className="font-bold ">{props.content3}</span>
...
// Each Component have its prop-type
// it is designed to make ease in changes

const date = new Date()
const year = date.getFullYear()
Footer.defaultProps = {
  column2Title: 'Support',
  link7: 'Customer Testimonials',
  link5: 'Privacy Policy',
  link8: 'Blog',
  action1: 'Subscribe ',
  content3: 'Designed by EmbedAI',
  link4: 'Terms of Service',
  logoSrc: '',
  cookiesLink: '/cookies-policy',
  content2: `© ${year} Customer Support Services. All rights reserved.`,

  link6: 'Chatbot Services',
  logoAlt: 'Customer Support Services Logo',
  link1: 'About Us',
